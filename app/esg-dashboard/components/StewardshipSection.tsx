        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">H&S Efforts</th>
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">H&S Function</th>
              ...
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">H&S Policy</th>
            </tr>
          </thead>
